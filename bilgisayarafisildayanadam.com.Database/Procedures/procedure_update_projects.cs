...
{
    [MADataName(Name = "[dbo].[procedure_update_projects]")]
    public class procedure_update_projects : MADaoProcedure<procedure_update_projects, procedure_update_projects.Result>
    {
        #region Enums
        public enum Result
        {
