...
{
    [MADataName(Name = "[dbo].[procedure_update_project_files_transfers__commit]")]
    public class procedure_update_project_files_transfers__commit : MADaoProcedure<procedure_update_project_files_transfers__commit, procedure_update_project_files_transfers__commit.Result>
    {
        #region Enums
        public enum Result
        {
