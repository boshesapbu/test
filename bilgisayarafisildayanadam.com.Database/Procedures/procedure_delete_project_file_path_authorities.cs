...
{
    [MADataName(Name = "[dbo].[procedure_delete_project_file_path_authorities]")]
    public class procedure_delete_project_file_path_authorities : MADaoProcedure<procedure_delete_project_file_path_authorities, procedure_delete_project_file_path_authorities.Result>
    {
        #region Enums
        public enum Result
        {
