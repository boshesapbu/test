...
{
    [MADataName(Name = "[dbo].[procedure_delete_projects]")]
    public class procedure_delete_projects : MADaoProcedure<procedure_delete_projects, procedure_delete_projects.Result>
    {
        #region Enums
        public enum Result
        {
